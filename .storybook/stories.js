...
storiesOf('Anchor', module)
	.add('default', () =>
		<Body>
			<span>Wow</span><Anchor /><span>, arrr.</span><br />
			<span>Jolly, undead tunas</span><Anchor /><span> darkly burn a mighty, scurvy mainland.</span><br />
			<Anchor /><span>Why does the son travel?</span><Anchor /><br />
			<span>Seas</span><Anchor /><Anchor /><Anchor /><span> die with power!</span><br />
		</Body>
	);
